          ...
          items: [
            {
              ...
              id: 'infoText1',
              name: 'infoText',
              html: "Please browse for either a CKL file generated by DISA's STIG Viewer or an XCCDF file from SPAWAR's SCAP Compliance Checker (SCC).<br><br>The imported file must contain results for:<p>Asset: <b>" + leaf.assetName + '</b><p>STIG: <b>' + leaf.benchmarkId + '</b>',
            }]
        },
        {
