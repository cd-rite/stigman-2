...
SM.DocWidget = Ext.extend(Ext.Panel, {
  initComponent: function() {
      ...
      const tpl = new Ext.XTemplate(
          ...
          `<div class='sm-home-widget-text'>What is <a target="_blank" href="https://cd-rite.github.io/stigman-2/#/">STIG Manager OSS</a>?</div>`,
          `<div class='sm-home-widget-subtitle'>First Time User?</div>`,
          `<div class='sm-home-widget-text'>Visit our <a target="_blank" href="https://github.com/NUWCDIVNPT/stig-manager/wiki">QuickStart User Guide</a> along with the rest of our documentation!</div>`,
          `<div class='sm-home-widget-subtitle'>User Guide</div>`,
          `<div class='sm-home-widget-text'>Check out our User Guide <a target="_blank" href="https://github.com/NUWCDIVNPT/stig-manager/tree/phase-1-dev/docs">for more in-depth info features and our development roadmap.</a></div>`,
